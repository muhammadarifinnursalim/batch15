...
CREATE TABLE `agents` (
  ...
  `COMMISSION` char(10) DEFAULT NULL,
...
CREATE TABLE `customer` (
  ...
  `OPENING_AMT` varchar(50) NOT NULL,
  `RECEIVE_AMT` varchar(50) NOT NULL,
  `PAYMENT_AMT` varchar(50) NOT NULL,
  `OUTSTANDING_AMT` varchar(50) NOT NULL,
...
CREATE TABLE `orders` (
  `ORD_NUM` varchar(60) NOT NULL,
  `ORD_AMOUNT` varchar(60) NOT NULL,
  `ADVANCE_AMOUNT` varchar(60) NOT NULL,
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`CUST_CODE`) REFERENCES `customer` (`CUST_CODE`),
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`AGENT_CODE`) REFERENCES `agents` (`AGENT_CODE`);
COMMIT;
